...
use OrderIT\Bundle\OrderBundle\Entity\Sector;
use OrderIT\Bundle\OrderBundle\Form\SectorType;
...
class SectorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrderBundle:Sector')->findAll();
     ...
     * @Method("POST")
     * @Template("OrderBundle:Sector:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrderBundle:Sector')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrderBundle:Sector:edit.html.twig")
     */
