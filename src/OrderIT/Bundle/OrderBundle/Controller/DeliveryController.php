...
use OrderIT\Bundle\OrderBundle\Form\DeliveryType;
...
class DeliveryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrderBundle:Delivery')->findAll();
     ...
     * @Method("POST")
     * @Template("OrderBundle:Delivery:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrderBundle:Delivery')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrderBundle:Delivery:edit.html.twig")
     */
